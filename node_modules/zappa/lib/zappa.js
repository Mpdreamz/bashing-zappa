(function() {
  ...
  copy_data_to = function(recipient, sources) {
    ...
    for (_i = 0, _len = sources.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        ...
        for (k in obj) {
          v = obj[k];
          _results2.push(!recipient[k] ? recipient[k] = v : void 0);
        }
        return _results2;
      })());
    }
  ...
  zappa.app = function(func) {
    var app, client, context, helpers, io, postrenders, route, verb, ws_handlers, _fn, _i, _len, _ref;
    context = {
      id: uuid(),
      zappa: zappa,
      express: express
    ...
    context.use = function() {
      var a, k, use, v, wrappers, _j, _len2, _results;
      wrappers = {
        static: function(p) {
          if (p == null) {
  ...
  zappa.run = function() {
    var a, app, host, port, root_function, zapp, _i, _len;
    host = null;
    port = 3000;
    root_function = null;
