...
Host.prototype.resizeScreen = function() {
...
Host.prototype.init = function() {               
  ...
  this.canvasDim = {
    width: 1 * this.canvas.width,
    height: 1 * this.canvas.height
  };
  
  this.images = {
    bg: createImage("background"),
    engine: createImage("test_unit01"),
    wreckball: createImage("wreck_ball_64x64"),
  };
